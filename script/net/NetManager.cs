...
class NetManager
{
	...
	public static void ReadListenfd(Socket listenfd){
		try{
			...
			Console.WriteLine(System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + " Accept " + clientfd.RemoteEndPoint.ToString());
	...
	public static void ReadClientfd(Socket clientfd){
		...
		//客户端关闭
		if(count <= 0 ){
			Console.WriteLine(System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + " Socket Close " + clientfd.RemoteEndPoint.ToString());
			Close(state);
			return;
		}
		//消息处理
